    ...
    <div class="col-lg-8">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{ route('post-add-portfolios') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="" placeholder="" name="technology">
                        </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            ...
                            <textarea class="form-control" id="editor" rows="3" name="details"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
